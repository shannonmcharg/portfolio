      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative">
        <div className="max-w-4xl mx-auto text-left">
          ...
          <p className="text-lg sm:text-xl text-muted-foreground max-w-2xl mb-4 leading-relaxed animate-slide-up [animation-delay:200ms]">
            I am a user experience designer and researcher specializing in interaction design, 
            information architecture, formative user research, prototyping, and product management. 
